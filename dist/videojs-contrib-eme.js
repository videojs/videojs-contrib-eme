...
exports.getSupportedKeySystem = getSupportedKeySystem;
var makeNewRequest = function makeNewRequest(_ref) {
  var mediaKeys = _ref.mediaKeys;
  var initDataType = _ref.initDataType;
  var initData = _ref.initData;
  var options = _ref.options;
  var getLicense = _ref.getLicense;
  var removeSession = _ref.removeSession;
    ...
    keySession.keyStatuses.forEach(function (status, keyId) {
      switch (status) {
        ...
        case 'internal-error':
          ...
          _videoJs2['default'].log.warn('Key status reported as "internal-error." Leaving the session open since we ' + 'don\'t have enough details to know if this error is fatal.', event);
          break;
      }
    });
...
var addSession = function addSession(_ref2) {
  ...
  var removeSession = _ref2.removeSession;
...
var setMediaKeys = function setMediaKeys(_ref3) {
  ...
  var createdMediaKeys = _ref3.createdMediaKeys;
  var options = _ref3.options;
  var getLicense = _ref3.getLicense;
  var removeSession = _ref3.removeSession;
...
var promisifyGetLicense = function promisifyGetLicense(getLicenseFn, player) {
...
var standard5July2016 = function standard5July2016(_ref4) {
  ...
  var initDataType = _ref4.initDataType;
  var initData = _ref4.initData;
  var options = _ref4.options;
  var removeSession = _ref4.removeSession;
  ...
  return keySystemPromise.then(function () {
    addSession({
      ...
      getLicense: video.keySystem ? promisifyGetLicense(standardizeKeySystemOptions(video.keySystem, options.keySystems[video.keySystem]).getLicense, player) : null,
      removeSession: removeSession
    });
  });
};
...
var addKeyToSession = function addKeyToSession(options, session, event, player) {
...
var createSession = function createSession(video, initData, options, player) {
...
var handleEncryptedEvent = function handleEncryptedEvent(event, options, sessions, player) {
  ...
  return (0, _eme.getSupportedKeySystem)(options.keySystems).then(function (_ref) {
    ...
    return (0, _eme.standard5July2016)({
      video: event.target,
...
var handleWebKitNeedKeyEvent = function handleWebKitNeedKeyEvent(event, options, player) {
...
var handleMsNeedKeyEvent = function handleMsNeedKeyEvent(event, options, sessions, player) {
